defmodule Notes.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule NotesWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Notes.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      # {Plugins.Phoenix, router: NotesWeb.Router, endpoint: NotesWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:notes, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
